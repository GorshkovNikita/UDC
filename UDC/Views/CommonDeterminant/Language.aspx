...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ul class="language-table">
        <li class="language-table-items-item">
            ...
            <span class="main-table-items-item-add add-index-button" onclick="addLanguagePlus(this)">+</span>
            <span class="main-table-items-item-add add-index-button" onclick="addLanguageSlash(this)">/</span>

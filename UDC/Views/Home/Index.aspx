...
<ul class="main-table-items">
    <% foreach (var item in Model.Where(parent => parent.ParentId == null)) { %>
        <li>
            ...
            <a href="../Home/MoreInfo?index=<%: Html.DisplayFor(modelItem => item.Id) %>"><span class="main-table-items-item-text"><span class="main-table-id"><%: Html.DisplayFor(modelItem => item.Value) %></span>&nbsp;<%: Html.DisplayFor(modelItem => item.Name) %></span></a>
            ...
            <% Html.RenderPartial("../Shared/MainIndexNodePartial", new UDC.Models.IndexModel(item.Id)); %>
        </li>
    <% } %>
</ul>
